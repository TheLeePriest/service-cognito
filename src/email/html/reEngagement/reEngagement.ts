...
<head>
  ...
  <title>We Miss You - CDK Insights</title>
        ...
        >
          ...
          <tr>
            <td align="center" style="padding: 0 24px 48px 24px;">
              ...
              <p style="margin: 0; font-size: 17px; color: #a8b5b0; line-height: 1.6;">
                Hi ${safeDisplayName}, it's been ${daysSinceLastScan} days since your last CDK Insights scan. Your infrastructure may have changed - let's make sure it's still secure and optimized.
              </p>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #00140f; border-radius: 16px;">
                <tr>
                  <td style="padding: 32px;">
                    <p style="margin: 0 0 20px 0; font-size: 16px; font-weight: 600; color: #fcf9f4;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 12px;">
                      <tr>
                        ...
                        <td style="padding-left: 8px;">
                          <p style="margin: 0; font-size: 14px; color: #a8b5b0;">New resources deployed to your stacks</p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 12px;">
                      <tr>
                        ...
                        <td style="padding-left: 8px;">
                          <p style="margin: 0; font-size: 14px; color: #a8b5b0;">Configuration changes that affect security</p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 12px;">
                      <tr>
                        ...
                        <td style="padding-left: 8px;">
                          <p style="margin: 0; font-size: 14px; color: #a8b5b0;">New AWS best practices we've added</p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td style="padding-left: 8px;">
                          <p style="margin: 0; font-size: 14px; color: #a8b5b0;">Cost optimization opportunities</p>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="padding: 0 24px 40px 24px;">
              ...
              <p style="margin: 0 0 16px 0; font-size: 14px; font-family: 'SF Mono', Monaco, 'Courier New', monospace; color: #88c1a8; background-color: #00140f; padding: 16px; border-radius: 8px;">
