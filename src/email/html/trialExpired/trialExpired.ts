...
<head>
  ...
  <title>Your CDK Insights Trial Has Ended</title>
          ...
          <tr>
            <td align="center" style="padding: 0 24px 48px 24px;">
              ...
              <p style="margin: 0; font-size: 17px; color: #a8b5b0; line-height: 1.6;">
                Hi ${safeDisplayName}, your CDK Insights trial period has come to an end. We hope you enjoyed exploring the platform.
              </p>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #00140f; border-radius: 16px;">
                <tr>
                  <td style="padding: 32px;">
                    <p style="margin: 0 0 8px 0; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; color: #f4a261;">
                      Account Status
                    </p>
                    ...
                    <p style="margin: 0; font-size: 14px; color: #a8b5b0; line-height: 1.6;">
                      Your account has been downgraded to the free tier. Upgrade to restore full access.
                    </p>
                  </td>
                </tr>
              </table>
            ...
            <td style="padding: 0 24px 40px 24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 16px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <p style="margin: 0; font-size: 15px; color: #a8b5b0;">AI-powered infrastructure analysis</p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 16px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <p style="margin: 0; font-size: 15px; color: #a8b5b0;">Unlimited resource scanning</p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 16px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <p style="margin: 0; font-size: 15px; color: #a8b5b0;">Security and cost optimization insights</p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <p style="margin: 0; font-size: 15px; color: #a8b5b0;">Priority support</p>
                  </td>
                </tr>
              </table>
            </td>
