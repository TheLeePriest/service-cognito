              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #00140f; border-radius: 16px;">
                <tr>
                  <td style="padding: 32px;">
                    ...
                    <p style="margin: 0 0 16px 0; font-size: 15px; font-weight: 600; font-family: 'SF Mono', Monaco, 'Courier New', monospace; color: #fcf9f4; word-break: break-all;">
                      ${safeLicenseKey}
                    </p>
                    <table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="padding-right: 24px;">
                          ...
                          <p style="margin: 0; font-size: 15px; font-weight: 600; color: #fcf9f4;">${safeLicenseType}</p>
                        </td>
                        <td>
            ...
            <td style="padding: 0 24px 40px 24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <p style="margin: 0 0 4px 0; font-size: 15px; font-weight: 600; color: #fcf9f4;">Install the CLI</p>
                    <p style="margin: 0; font-size: 14px; font-family: 'SF Mono', Monaco, 'Courier New', monospace; color: #a8b5b0;">npm install -g cdk-insights</p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <p style="margin: 0 0 4px 0; font-size: 15px; font-weight: 600; color: #fcf9f4;">Run your first scan</p>
                    <p style="margin: 0; font-size: 14px; font-family: 'SF Mono', Monaco, 'Courier New', monospace; color: #a8b5b0;">npx cdk-insights scan</p>
                  </td>
                </tr>
              </table>
            </td>
